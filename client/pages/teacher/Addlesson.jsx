    ...
    className='mt-20 w-full flex'>
        ...
        <div className='w-full h-[750px] bg-[#3B82F6]/10 flex justify-center items-center'>
            <div className='items-center justify-center min-w-md rounded-2xl  bg-[#3B82F6]/30 p-10 space-y-10'>
                <form>
                    <div>
                        <label htmlFor="lessonName" className='block text-xl font-bold'>Lesson name</label>
                        <input type="text" id='lessonName' className='w-full bg-gray-50 py-3 px-5 rounded-2xl mt-3 font-semibold text-gray-600' placeholder='Enter lesson name' />
                    </div>
                    <div className='mt-5'>
                        <label htmlFor="description" className='block text-xl font-bold'>Description</label>
                        <input type="text" id='description' className='w-full bg-gray-50 py-3 px-5 rounded-2xl mt-3 font-semibold text-gray-600' placeholder='Enter lesson description' />
                    </div>
                    <div className='mt-5'>
                        <label htmlFor="name" className='block text-xl font-bold'>Content</label>
                        <input type="text" id='content' className='w-full bg-gray-50 py-3 px-5 rounded-2xl mt-3 font-semibold text-gray-600' placeholder='Enter content here' />
                    </div>
                </form>

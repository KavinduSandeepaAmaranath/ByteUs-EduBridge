        ...
        <div className='min-w-md bg-[#3B82F6]/15 p-5 rounded-xl'>
            ...
            <form action="" onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input type="password" value={confirmPasssword} onChange={(e) => setConfirmPassword(e.target.value)} id='password' className='w-full bg-gray-50 py-3 px-5 rounded-2xl mt-3 font-semibold text-gray-600' placeholder='Confirm your password here' />
                </div>
                <div>
